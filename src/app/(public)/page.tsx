  ...
  return (
    <main className="min-h-screen bg-black relative">
      ...
      <section id="demo" className="py-16 sm:py-24 relative">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_40%_at_50%_50%,rgba(255,255,255,0.02),transparent)]" />
        <div className="relative max-w-5xl mx-auto px-6">
          <FadeUp>
            <p className="text-xs uppercase tracking-[0.35em] text-white/40 text-center mb-8 sm:mb-12">
          ...
          <FadeUp delay={0.15}>
            <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-black/50 border border-white/5">
              <video
                ...
                muted
                playsInline
                poster="/video/veqtis-poster.jpg"
                preload="metadata"
                className="w-full"
                style={{ aspectRatio: "16/9" }}
              >
                <source src="/video/veqtis-brand.mp4" type="video/mp4" />
              </video>
            </div>
          </FadeUp>
        </div>
